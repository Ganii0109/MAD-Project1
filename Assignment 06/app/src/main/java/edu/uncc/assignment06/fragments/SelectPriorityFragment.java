...
public class SelectPriorityFragment extends Fragment {
    ...
    SelectionRecyclerViewAdapter adapter;
     ...
     * @return A new instance of fragment SelectPriorityFragment.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new SelectionRecyclerViewAdapter(priorities, mListener,"priority");
    ...
    public void onAttach(@NonNull Context context) {
        ...
        //if (context instanceof ISelectionListener) {
