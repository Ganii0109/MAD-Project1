...
public class SelectLivingStatusFragment extends Fragment {
        ...
        binding.buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    selectedLstatus=radioButton.getText().toString();
                    ilistener.submitBtnLStatus(selectedLstatus);
                }
                catch (Exception e)
                {
                    Toast.makeText(getActivity(),"Please select the Living status",Toast.LENGTH_LONG).show();
                }
    ...
    ILivingStatus ilistener;

    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        ilistener= (ILivingStatus) context;
    }

    public interface ILivingStatus{
        void cancelBtnLStatus();
        void submitBtnLStatus(String selectedLstatus);
    }
}