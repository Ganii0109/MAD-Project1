...
public class SelectMaritalStatusFragment extends Fragment {
        ...
        binding.buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    selectedMstatus=radioButton.getText().toString();
                    ilistener.submitbtnMstatus(selectedMstatus);
                }
                catch (Exception e)
                {
                    Toast.makeText(getActivity(),"Please the Marital Status",Toast.LENGTH_LONG).show();
                }
    ...
    IselectedMstatus ilistener;

    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        ilistener= (IselectedMstatus) context;
    }

    public interface IselectedMstatus{
        void cancelbtnMstatus();
        void submitbtnMstatus(String selectedMstatus);
    }
}